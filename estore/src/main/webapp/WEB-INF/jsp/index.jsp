...
<!--文件体开始-->
       ...
       <c:forEach items="${books }" var="book">
       		<tr>
				...
				<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;<a href="/book/id/${book.id }">${book.name }</a></td>
				<td class=tablebody2 valign=middle align=center width="">${book.price }</td>
				<td class=tablebody1 valign=middle align=center width=""><a href="/cart/add/${book.id }">
